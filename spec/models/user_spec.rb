...
RSpec.describe User, type: :model do
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'authentificates user with valid credentals' do
      ...
      @user.save
      user_auth = User.authenticate_with_credentials('patrick@example.com', 'wakeup')
      expect(user_auth.name).to eq('SpongeBob SquarePants')
    end
    ...
    it 'returns nil is credentials are wrong' do
      ...
      @user.save
      user_auth = User.authenticate_with_credentials('patrick@example.com', 'wake')
